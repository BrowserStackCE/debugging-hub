...
import { getBrowserStackAdminCredentials, setBrowserStackAdminCredentials } from './channelHandlers/credentials-api';
import getStorage from './storage';
import StorageKeys from './constants/storage-keys';
import CONFIG from './constants/config';

import { mkdirSync } from 'fs'
import { getAutomateSessionDetails, getParsedAutomateTextLogs, getSeleniumLogs, getHarLogs } from './channelHandlers/browserstack-api';
...
app.on('ready', async () => {
  ...
  try {
    const creds = await storage.get<BrowserStackCredentials>(StorageKeys.bstackAdminCredentials);
